...
var bishBashBoshRecipes = [
    ...
    { location: 'Bish Bash Bosh p. 35', name: 'Tom Kha', type: ''},
    { location: 'Bish Bash Bosh p. 36', name: 'Vietnamese Sticky Tofu', type: ''},
    { location: 'Bish Bash Bosh p. 39', name: 'Faux Gras', type: ''},
    ...
    { location: 'Bish Bash Bosh p. 58', name: 'Greek Gyroos', type: ''},
    ...
    { location: 'Bish Bash Bosh p. 88', name: 'Sweet Potato Tikka Masala', type: ''},
