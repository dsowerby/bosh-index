...
var boshHealthyVeganRecipes = [
    ...
    { location: 'BOSH! Healthy Vegan p. 73', name: 'Healthy Saag Paneer', type: 'lighter tofu miso onion garlic ginger tomatoes spinach cumin garam masala tumeric chilli soya cream whole tortilla'},
    ...
    { location: 'BOSH! Healthy Vegan p. 80', name: 'Tom Yummo Soup', type: 'lighter coconut milk lemongrass'},
    { location: 'BOSH! Healthy Vegan p. 83', name: 'Mixed Veg Katsu Curry', type: 'lighter sweet potato aubergine courgette miso onion garlic curry maple syrup tumeric sambar garam masala coconut milk stock basmati sesame seeds'},
    ...
    { location: 'BOSH! Healthy Vegan p. 97', name: 'Niçoise Salad', type: 'greener chickpeas broad beans'},
    { location: 'BOSH! Healthy Vegan p. 98', name: 'BOSH! Burnt Eggplant', type: 'greener'},
    { location: 'BOSH! Healthy Vegan p. 101', name: 'Satay Salad', type: 'greener soba noodles frozen peas mangetout pak choi spring onions peanuts coriander pepper lime carrots spinach garlic ginger sesame soy sauce maple syrup peanut butter'},
    ...
    { location: 'BOSH! Healthy Vegan p. 112', name: 'Green Shakshuka', type: 'greener avocado cannellini beans'},
    ...
    { location: 'BOSH! Healthy Vegan p. 118', name: 'Jerk Jackfruit Salad \'n\' Beans', type: 'greener cashew nuts jackfruit' },
    { location: 'BOSH! Healthy Vegan p. 120', name: 'Thai Tempeh Salad', type: 'greener cabbage carrots'},
    { location: 'BOSH! Healthy Vegan p. 125', name: 'Braised Jack Chili', type: 'heartier jackfruit'},
    { location: 'BOSH! Healthy Vegan p. 127', name: 'Feijoada & Slaw', type: 'heartier black beans carrots'},
    { location: 'BOSH! Healthy Vegan p. 128', name: 'Hearty, Herby Stew', type: 'heartier cannellini beans'},
    { location: 'BOSH! Healthy Vegan p. 131', name: 'Jammin\' Jambalaya', type: 'heartier rice jackfruit'},
    { location: 'BOSH! Healthy Vegan p. 133', name: 'Bangin\' Bolognese', type: 'heartier'},
    { location: 'BOSH! Healthy Vegan p. 134', name: '“Chorizo” Pasta', type: 'heartier sausage paprika fennel cayenne onion garlic pepper tomato puree tomatoes spinach parsley'},
    { location: 'BOSH! Healthy Vegan p. 137', name: 'Pasta e Fagioli', type: 'heartier carrots bortolli kidney beans onion garlic rosemary thyme kale carrots red wine tomatoes bay leaf pasta stock'},
    ...
    { location: 'BOSH! Healthy Vegan p. 142', name: 'Thai No-Fishcakes', type: 'heartier jackfruit'},
    ...
    { location: 'BOSH! Healthy Vegan p. 150', name: 'Emj\'s Hearty Hotpot', type: 'heartier cannellini beans'},
    { location: 'BOSH! Healthy Vegan p. 153', name: 'Sunny Sri Lankan Curry', type: 'heartier cashew nuts coconut milk'},
    { location: 'BOSH! Healthy Vegan p. 154', name: 'Salad Lasagna', type: 'heartier onion garlic asparagus mint kale cheese lasagne peas broad beans salad milk'},
    { location: 'BOSH! Healthy Vegan p. 159', name: 'Easy & Healthy Roast Dinner', type: 'heartier potatoes carrots parsnips sprouts onion garlic cornflour tomato puree marmite maple syrup red wine mushrooms rosemary thyme chestnuts pecans bread filo pastry'},
    ...
    { location: 'BOSH! Healthy Vegan p. 173', name: 'Hoisin Sauce', type: 'heartier black beans aubergine cardammon lime tamarind maple syrup coconut coconut milk drink cloves star anise cinnamon stick lemongrass flour shallots chilli onion chilli basmati rice coriander'},
    { location: 'BOSH! Healthy Vegan p. 175', name: 'Legendary Rendang', type: 'heartier aubergine rice lemongrass'},
    { location: 'BOSH! Healthy Vegan p. 178', name: 'Not-That-Naughty Burger with Frisbee Fries', type: 'heartieronion garlic chilli tomatoes paprika maple syrup lime sweet potato rice breadcrumbs cumin paprika flour black beans potato yoghurt sriracha mustard wine vinegar cheese tomatoes'},
    ...
    { location: 'BOSH! Healthy Vegan p. 191', name: 'Anna\'s Blueberry Toast Loaf', type: 'treats banana'},
    { location: 'BOSH! Healthy Vegan p. 193', name: 'Chocolate & Banana Muffins', type: 'treats'},
    { location: 'BOSH! Healthy Vegan p. 194', name: 'Salted Caramel Apple Crumble & Custard', type: 'treats banana'},
    ...
    { location: 'BOSH! Healthy Vegan p. 198', name: 'Cookie Dough BOSH! Balls', type: 'treats chocolate banana'},
    { location: 'BOSH! Healthy Vegan p. 199', name: 'BOSH! Brownie Balls', type: 'treats chocolate'},
    { location: 'BOSH! Healthy Vegan p. 203', name: 'Jacked Flapjacks', type: 'treats oat bars chocolate banana'},
    { location: 'BOSH! Healthy Vegan p. 204', name: 'Banana Berry Ice Cream', type: 'treats berries'},
    { location: 'BOSH! Healthy Vegan p. 207', name: 'PB&J Thumbprint Cookies', type: 'treats banana'},
    { location: 'BOSH! Healthy Vegan p. 210', name: 'Green Goddess Smoothie', type: 'breakfast berries' },
    { location: 'BOSH! Healthy Vegan p. 210', name: 'Berry Boost Smoothie', type: 'breakfast banana' },
